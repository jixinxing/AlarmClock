...
import cn.just.alarmclock.controller.OnWheelChangedListener;
import cn.just.alarmclock.controller.OnWheelScrollListener;
import cn.just.alarmclock.controller.WheelAdapter;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF404040; // 中间那排选中的颜色

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF909090; // 其他的未选中的颜色

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFe4e4e4, // 上下边颜色
			0x00ffffff, 0x00ffffff }; // 上下边内部颜色

	/** Additional items height (is added to standard text item height) */
	private static final int ADDITIONAL_ITEM_HEIGHT = 50; // 每行高度
